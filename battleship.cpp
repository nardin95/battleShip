...
public:
    ...
    BattleshipGame()
    {
        ...
        playerSub = Battleship();
        computerSub = Battleship();
    }
...
private:
    ...
    void addPieceToBoard(char board[SIZE][SIZE], const Battleship& piece)
    {
    ...
    bool isSunk(char board[SIZE][SIZE], const Battleship& piece)
    {
        int row = piece.getTopLeftRow();
        int column = piece.getTopLeftColumn();
        for(int i=0; i<piece.getLength(); i++)
    ...
    bool isValidPlacement(char board[SIZE][SIZE], const Battleship& piece)
    {
        int row = piece.getTopLeftRow();
        int column = piece.getTopLeftColumn();
